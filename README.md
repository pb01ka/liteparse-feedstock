...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/liteparse-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/liteparse-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=27952&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/liteparse-feedstock?branchName=main">
          </a>
        </summary>
        <table>
...
Installing `liteparse` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
pixi add liteparse python-liteparse
# for installing globally
pixi global install liteparse python-liteparse
```
...
It is possible to list all of the versions of `liteparse` available on your platform:

<details>
<summary>With conda</summary>

```
conda search liteparse --channel conda-forge
```
...
```
mamba search liteparse --channel conda-forge
```
...
```
pixi search liteparse --channel conda-forge
```
...
mamba repoquery search liteparse --channel conda-forge

# List packages depending on `liteparse`:
mamba repoquery whoneeds liteparse --channel conda-forge

# List dependencies of `liteparse`:
mamba repoquery depends liteparse --channel conda-forge
```
...
Updating liteparse-feedstock
============================

If you would like to improve the liteparse recipe or build a new
...
Note that all branches in the conda-forge/liteparse-feedstock are
